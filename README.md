...
- **Авто (EDSM → Spansh fallback)** — сначала запрос к EDSM, при ошибке/таймауте/пустом ответе используется Spansh.
- **Только EDSM** — данные запрашиваются только из EDSM, без fallback.
- **Только Spansh** — данные запрашиваются только из Spansh.
