...
- **Только EDAstro** — прямой запрос к `https://edastro.com/api/system/bodies` по имени системы; полезно как дополнительный источник, где могут присутствовать ID барицентров.
